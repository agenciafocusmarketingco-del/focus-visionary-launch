  ...
  return <section id="clients" className="section-padding bg-secondary text-white">
      <div className="max-w-7xl mx-auto bg-zinc-950 py-[20px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => <Card key={index} className="bg-white/10 border-white/20 backdrop-blur-sm hover:bg-white/15 transition-all duration-300 card-premium">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => <Star key={i} size={16} className="text-primary fill-current" />)}
                </div>
